...
@PrintfConfigEnd
5.使用该样例建议去除R45/R46/R47/R48四个电阻。板载默认没有焊接这四个电阻。
6.如果需要使用按键:
...
@PrintfConfigEnd
5.It is recommended to remove the four resistors R45/R46/R47/R48 using this 
sample. These four resistors are not soldered by default on board.
