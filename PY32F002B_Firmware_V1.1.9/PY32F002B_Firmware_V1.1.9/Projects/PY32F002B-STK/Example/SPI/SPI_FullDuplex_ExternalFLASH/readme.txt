...
@PrintfConfigEnd
4.使用该样例需焊接R45/R46/R47/R48四个电阻。板载默认没有焊接这四个电阻。
5.如果需要使用按键:
...
@PrintfConfigEnd
4. The use of the sample need to weld R45/R46/R47/R48 four resistors. By default,
these four resistors are not soldered on board.
